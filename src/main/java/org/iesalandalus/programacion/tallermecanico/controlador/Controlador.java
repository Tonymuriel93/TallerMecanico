    ...
    public void actualizar(Evento evento) {
        try {
            ...
            switch (evento) {
                ...
                case BUSCAR_VEHICULO -> { modelo.insertar(vista.leerVehiculo()); resultado = "Vehiculo insertado correctamente";}
                ...
                case MODIFICAR_CLIENTE -> { modelo.modificar(vista.leerClienteDni(), vista.leerNuevoNombre(), vista.leerNuevoTelefono()); resultado = "El cliente se ha modificado";}
                ...
                case ANADIR_PRECIO_MATERIAL_TRABAJO -> { modelo.anadirPrecioMaterial(vista.leerTrabajoVehiculo(), vista.leerPrecioMaterial()); resultado = "Precio del material"; }
                ...
                case BUSCAR_TRABAJO(33, "Buscar trabajo."),
                case BORRAR_TRABAJO(34, "Borrar trabajo"),
                case SALIR -> terminar();
            }
